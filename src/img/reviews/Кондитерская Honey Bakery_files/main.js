...
var wrapperBtnMenu = document.querySelector('.header__menu-btn-wrapper');
var menuBtn = wrapperBtnMenu.querySelector('.header__menu-controller');
var burger = menuBtn.querySelector('.header__burger');
var cross = menuBtn.querySelector('.header__cross');
var menu = document.querySelector('.header__menu');
var menuItems = menu.querySelectorAll('.header__menu-item');
var overlay = document.querySelector('.overlay');
var headerOpenedClass = 'header--menu-opened';
var AnswerOpenedClass = 'answers--answer-opened';
var specialsBtn = document.querySelector('.specials__button');

var adjustDesktopAndTablet = function adjustDesktopAndTablet() {
  ...
  menuItems.forEach(function (item) {
    return item.classList.remove('button');
  });
};
...
var adjustMobile = function adjustMobile() {
  ...
  menuItems.forEach(function (item) {
    return item.classList.add('button');
  });
};

var checkWindowWidth = function checkWindowWidth() {
  if (window.matchMedia("(max-width: ".concat(WindowBreakpoints.TABLET, "px)")).matches) {
...
var RecomendationSlider = /*#__PURE__*/function () {
  function RecomendationSlider(sliderContent, btnPrev, btnNext, activeClass) {
    _classCallCheck(this, RecomendationSlider);
  ...
  _createClass(RecomendationSlider, [{
    key: "slider",
    value: function slider() {
      ...
      this.btnNext.addEventListener('click', function () {
        if (_this.index == _this.sliderContentLength - 1) {
          _this.index = 0;
        } else {
          _this.index++;
        }

        _this.sliderContent.forEach(function (item) {
          item.classList.remove(_this.activeClass);
        });

        _this.sliderContent[_this.index].classList.add(_this.activeClass);
      });
      this.btnPrev.addEventListener('click', function () {
        if (_this.index == 0) {
          _this.index = _this.sliderContentLength - 1;
        } else {
          _this.index--;
        }
  ...
  return RecomendationSlider;
}(); // АККОРДИОН


document.querySelectorAll('.answers__item').forEach(function (item) {
...
var Slider = /*#__PURE__*/function () {
  function Slider(photoInner, photoWrapper, sliderContent, btnPrev, btnNext, activeClass) {
  ...
  _createClass(Slider, [{
    ...
    value: function slider() {
      ...
      this.sliderContent[this.index].classList.add(this.activeClass);
      this.btnNext.addEventListener('click', function () {
        if (_this2.index == _this2.sliderContentLength - 1) {
          _this2.index = 0;
          _this2.offsetPhoto = 0;
        } else {
          _this2.index++;
          _this2.offsetPhoto += _this2.photoWidth;
        }

        _this2.photoInner.style.transform = "translateX(-".concat(_this2.offsetPhoto, "px)");

        _this2.sliderContent.forEach(function (item) {
          item.classList.remove(_this2.activeClass);
        });

        _this2.sliderContent[_this2.index].classList.add(_this2.activeClass);
      });
      this.btnPrev.addEventListener('click', function () {
        if (_this2.index == 0) {
          _this2.index = _this2.sliderContentLength - 1;
          _this2.offsetPhoto = _this2.photoWidth * (_this2.sliderContentLength - 1);
        } else {
          _this2.index--;
          _this2.offsetPhoto -= _this2.photoWidth;
        }
...
new Slider('.feedback__photo-inner', '.feedback__photo-wrapper', '.feedback__block-content', '.feedback__button--left', '.feedback__button--right', 'feedback__block-content--active').slider();
...
/******/ 	(() => {
/******/ 		__webpack_require__.h = () => "ab258479dc5821572e2d"
/******/ 	})();
/******/ 	
...
/******/ 		
/******/ 		var deferredModules = [
/******/ 			["./js/main.js","vendors-node_modules_mini-css-extract-plugin_dist_hmr_hotModuleReplacement_js-node_modules_we-a0114e"],
/******/ 			["../node_modules/webpack-dev-server/client/index.js?http://localhost:3000","vendors-node_modules_mini-css-extract-plugin_dist_hmr_hotModuleReplacement_js-node_modules_we-a0114e"],
/******/ 			["../node_modules/webpack/hot/dev-server.js","vendors-node_modules_mini-css-extract-plugin_dist_hmr_hotModuleReplacement_js-node_modules_we-a0114e"]
/******/ 		];
